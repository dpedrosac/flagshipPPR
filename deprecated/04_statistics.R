...
# Get user name (works on Windows and alomost all other systems)
user_name <- Sys.getenv("USERNAME", unset = Sys.info()[["user"]])

# You could extend this section with more else-if blocks for other users
if (user_name == "akoel") {
...
# Define path where results are save (this folder will be created if it doesn't exist and this part could be on top)
